...
ο 본 방침은  :  2019년 11월 1일 부터 시행됩니다.

■ 수집하는 개인정보 항목
회사는  고객상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.

ο 수집항목 : 이름 ,  휴대전화번호 , 이메일  , 프로젝트 예정 주소
ο 개인정보 수집방법 : 홈페이지(견적의뢰) 
...
ο 마케팅 및 광고에 활용 : 이벤트 등 광고성 정보 전달 , 인구통계학적 특성에 따른 서비스 제공 및 광고 게재

■ 개인정보의 보유 및 이용기간
원칙적으로, 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 아래의 이유로 명시한 기간 동안 보존합니다.

보존 항목 : 이름, 휴대전화번호, 이메일, 프로젝트 예정 주소
보존 근거 : 견적의뢰
보존 기간 : 3년
